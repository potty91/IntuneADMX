...
{
<#
This script builds on the script created here https://msendpointmgr.com/2019/01/17/use-intune-graph-api-export-and-import-intune-admx-templates/
by Zeng (Sandy) Yinghua.

This script imports ADMX settings from a single file per policy rather then from a folder full of indivudal policies.

Author: Mat Pottinger

####################################################
Version 1.0			 2020-04-20 First version
####################################################
#>
...
#>
	...
	$ImportPath = "C:\Working Area\Intune-PowerShell\DeviceConfiguration\import"
